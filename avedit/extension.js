...
{
 if (index>0 && selectedAVSource.type<30 && pos>-1)
 {
...
function addLiveFlashRecording(url)
{
 var index=-1;
...
function FlashLiveCapture()
{
 ...
 function getHTML()
 {
  ...
  var s='<object '+data+
   ...
   ' <param name="flashvars" value="server='+flashServer+'&title='+window.document.title+'&host='+flashHost+'&path='+flashPath+'" />\n'+
