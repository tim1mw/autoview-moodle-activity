...
$string['xmlhelp']= 'Dans la plupart des cas le fichier de configuration par défaut conviendra. Il est directement créé à la racine des fichiers du cours '.
 'à partir du nom de la ressource AutoView. Cependant, si vous avez copié une présentation AutoView à partir d\'un autre'.
 ' décochez la case et copiez le nom du fichier .avx de configuration de la présentation ici. Vous pouvez également décocher la case et '.
 ' utiliser un fichier d\'extension .avx si vous voulez pointer manuellement un fichier de configuration AutoView.';
