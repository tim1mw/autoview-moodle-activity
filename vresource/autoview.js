...
var OTHER=0;
var LINUX=1, WINDOWS=2, SUNOS=3, APPLEMAC=4, SYMBIAN=5, ANDROID=6;
...
function printStandaloneHTML()
{
 ...
 {
  document.writeln("<div align=\"center\" style=\"height:"+avHeight+";\"><table class=\"display-noslides\" summary=\"Layout table\"><tr>\n");
  if (videoPosition==VIDEOLEFT)
...
*/
  ...
  catch (e)
  {
   if (typeof("Components")!="undefined")
    ...
    alert("Error in monitoring thread "+e);
   clearInterval(monitor);
  }
}
...
function OOFlashSlide(url)
{
 ...
 {
  var data='type="application/x-shockwave-flash" data="'+baseRef+this.url+'"\n';
  if (browser==MSIE)
  ...
  return '<object '+data+
   ...
   ' <param name="movie" value="'+baseRef+this.url+'" />\n'+ 
 ...
 function getHTML()
 {
  ...
  if (browser==MSIE)
  {
   return '<object classid="clsid:8AD9C840-044E-11D1-B3E9-00805F499D93"\n'
    ...
    +'<param name="audioSource" value="'+baseRef+this.url+'" />\n'
...
function VLCVideo(url,speed)
{
 ...
 function getHTML()
 {
  ...
  if (this.url.indexOf("http://")<0 && this.url.indexOf("https://")<0 && this.url.indexOf("rtsp://")<0)
  {
   urlToUse=baseRef+urlToUse;
  }

  var data=" type=\"application/x-vlc-plugin\" data=\""+urlToUse+"\" ";
  if (browser==MSIE)
...
function FlashVideo(url,speed)
{
 ...
 function getPosition()
 {
  if (typeof(getPlayer())!="undefined")
  {
   if (hasFlashLite)
   {
    return getPlayer().GetVariable("time")*1000;
   }
...
function HTML5Video(url, speed)
{
 ...
 function getIFrameHTML()
 {
  ...
  var x="<!DOCTYPE html>"+
   ...
   "<video style='margin-left:auto;margin-right:auto;' src='"+urlToUse+"' "+
