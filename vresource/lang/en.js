...
data["nohtml5"]="Your web browser does not have built in video support (HTML 5).";
...
data["flashfailed"]="We have detected that your browser does not support the required functions for the presentation slide "+
  "synchronisation and buttons to work when using the Macromedia Flash slide format. "+
  "If you are using Mozilla or Netscape 6/7, we have found that if you have upgraded your browser from "+
  "an older version it is sometimes necessary to update the Macromedia Flash player plugin before it will work "+
  "properly with the upgraded browser. Visit http://www.macromedia.com to get the latest version of the Flash Player. "+
