...
function RealPlayerVideo(url,speed,useMonitor)
{
 ...
 function getPosition()
 {
  ...
  if (typeof(player)=="undefined")
   ...
   return parseInt(player.GetPosition());
 }
...
function QuicktimeVideo(url,speed, useMonitor)
{
 ...
 function getPosition()
 {
  var player=this.getPlayer();
  if (typeof(player)!="undefined")
   return parseInt((player.GetTime()/player.GetTimeScale())*1000);
  else
   return -1;
 }
...
function WindowsMediaVideo(url,speed,useMonitor)
{
 ...
 function getPosition()
 {
  if (typeof(this.getPlayer())!="undefined")
   return parseInt(this.getPlayer().Controls.CurrentPosition*1000);
  else
   return -1;
 }
...
function VLCVideo(url,speed)
{
 ...
 function getPosition()
 {
  if (typeof(getPlayer())!="undefined")
   return parseInt(getPlayer().input.time);
  else
   return -1;
 }
...
function SilverlightVideo(url,speed)
{
 ...
 {
  if (typeof(getPlayer())!="undefined")
   return parseInt(getPlayer().PlaybackPositionValue);
  else
   return -1;
 }
