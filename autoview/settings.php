...
$spds=array("768"=>768, "512"=>512, "256"=>256, "128"=>128, "96"=>96, "64"=>64, "48"=>48, "32"=>32, "24"=>24,
    "20"=>20, "16"=>16, "12"=>12);
$settings->add(new admin_setting_configselect('autoview/max_broadcast_kbps', get_string('configmax_broadcast_kbps', 'autoview'),
                   get_string('configmax_broadcast_kbps2', 'autoview'), 768, $spds));

$settings->add(new admin_setting_configselect('autoview/max_record_kbps', get_string('configmax_record_kbps', 'autoview'),
